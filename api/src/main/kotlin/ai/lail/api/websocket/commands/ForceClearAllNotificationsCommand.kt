...
class ForceClearAllNotificationsCommand(body: CommandContent) : WebSocketCommand(body) {
    override val event: WebSocketEvent = WebSocketEvent.ForceClearAllNotifications
    ...
    override fun handle(response: WebSocketResponse, context: ApplicationContext) {
        ...
        try {
            ...
            val updatedNotifications = notificationService.clearAllNotifications(targetId)
