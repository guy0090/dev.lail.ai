...
class ForceUnfollowUserCommand(body: CommandContent) : WebSocketCommand(body) {
    override val event: WebSocketEvent = WebSocketEvent.ForceUnfollowUser
    ...
    override fun handle(response: WebSocketResponse, context: ApplicationContext) {
        ...
        try {
            ...
            content.put("message", "$userId force unfollowed user $targetId")
