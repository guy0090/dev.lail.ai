...
class ForceClearNotificationsCommand(body: CommandContent) : WebSocketCommand(body) {
    override val event: WebSocketEvent = WebSocketEvent.ForceClearNotifications
    ...
    override fun handle(response: WebSocketResponse, context: ApplicationContext) {
        ...
        try {
            ...
            val updatedNotifications = notificationService.clearNotifications(targetId, notificationIds)
